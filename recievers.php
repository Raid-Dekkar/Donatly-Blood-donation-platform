  ...
  <div class="page d-flex">
        <div class="sidebar bg-white p-20 p-relative">
          ...
          <ul>
            ...
            <li>
              <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="recievers.php">
      ...
      <div class="content w-full">
          ...
          <!-- </div> -->
          <!-- End Head -->
          <h1 class="p-relative">Recievers</h1>
          ...
          ?>
            ...
            <div class="friend bg-white rad-6 p-20 p-relative">
                ...
                <div class="txt-c">
                    <?php if($rows11["gender_r"] == 'male'){ ?>
                       <img class="rad-half mt-10 mb-10 w-100 h-100" src="imgs/team-01.png" alt="" />
                    <?php } ?> 
                    <?php if($rows11["gender_r"] == 'female'){ ?>
                       <img class="rad-half mt-10 mb-10 w-100 h-100" src="imgs/team-04.png" alt="" /> 
                    <?php } ?> 
                    <h4 class="m-0"><?php echo  $rows10["first_name"] . " ";?><?php echo  $rows10["last_name"];?></h4>
                    <p class="c-grey fs-13 mt-5 mb-0"><?php echo  $rows10["user_name"] ;?></p>
                </div>
                ...
                <div class="icons fs-14 p-relative">
                    <div class="mb-10">
                        ...
                        <span>Id: </span>
                        <span class="field"><?php echo  $rows11["id"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-solid fa-phone fa-fw"></i>
                        <span>Phone number</span>
                        <span class="field"><?php echo  $rows11["phone_number_r"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-regular fa-calendar fa-fw"></i>
                        <span>Birth Date: </span>
                        <span class="field"><?php echo  $rows11["birth_date_r"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-solid fa-building fa-fw"></i>
                        <span>City: </span>
                        <span class="field"><?php echo  $rows11["city_r"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-solid fa-venus-mars fa-fw"></i>
                        <span>Gender: </span>
                        <span class="field"><?php echo  $rows11["gender_r"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-solid fa-vial fa-fw"></i>
                        <span>Blood type:</span>
                        <span class="field"><?php echo  $rows11["blood_type_r"];?></span>
                    </div>
                    <div class="mb-10">
                        <i class="fa-solid fa-vial fa-fw"></i>
                        <span>Medical Condition:</span>
                        <span class="field"><?php echo  $rows11["medical_condition"];?></span>
                    </div>
                </div>
                <div class="info between-flex fs-13">
                    <div>
                        <a class="bg-red c-white btn-shape" <?php echo "href='recievers.php?rm-reciever-id=$temp_id_r' " ?> style="border: none;cursor:pointer;font-size: 15px;font-weight: bold;padding: 4px 10px;">Remove</a>
                    </div>
                </div>
            </div>
            <?php
